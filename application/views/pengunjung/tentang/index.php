                    ...
                    <form role="form" action="<?= base_url('tentang/registrasi'); ?>" method="post"
                        ...
                        <div class="row">
                            <div class="form-group col-xl-6">
                                ...
                                <input name="username" class="form-control has-icon" type="text" placeholder="Username"
                                    required>
                                <?= form_error('username', '<small class="text-danger pl-1">', '</small>'); ?>
                            </div>
                            <div class="form-group col-xl-6">
                                <i class="fa fa-lock"></i>
                                <input name="password" type="text" class="form-control has-icon" placeholder="Password"
                                    required>
                        ...
                        <div class="row">
                            <div class="form-group col-xl-12">
                                <input name="nama_lengkap" class="form-control has-icon" type="text" placeholder="Nama"
                                    required>
                        ...
                        <div class="row">
                            <div class="form-group col-xl-6">
                                ...
                                <input name="tempat_lahir" class="form-control has-icon" type="text"
                                    placeholder="Tempat" required>
                                <?= form_error('tempat_lahir', '<small class="text-danger pl-1">', '</small>'); ?>
                            </div>
                            <div class="form-group col-xl-6">
                                <i class="fa fa-calendar"></i>
                                <input name="tanggal_lahir" type="text" class="form-control has-icon datepicker-here"
                                    data-language="en" placeholder="Tanggal Lahir" required>
                        ...
                        <div class="row">
                            <div class="form-group col-xl-6">
                                ...
                                <input name="no_hp" class="form-control has-icon" type="text" placeholder="Telepon/WA"
                                    required>
                                <?= form_error('no_hp', '<small class="text-danger pl-1">', '</small>'); ?>
                            </div>
                            <div class="form-group col-xl-6">
                                <i class="fa fa-envelope"></i>
                                <input name="email" type="text" class="form-control data-language=" en"
                        ...
                        <div class="row">
                            <div class="form-group col-xl-12">
                                <i class="fa fa-map-marker"></i>
                                <input name="alamat" class="form-control has-icon" type="text" placeholder="Alamat"
                                    required>
        ...
        <div class="row align-items-center">
            <div class="col-lg-5">
                <div class="call-action-img text-lg-left text-center">
                    <img src="<?= base_url('assets/depan/') ?>assets/images/elements/call-action-personj.png"
                        alt="image">
                </div>
            </div>
