                                    ...
                                    <table id="example1" class="table table-bordered table-striped dataTable"
                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th style="width: 206.484px;">Tipe, Jenis, Warna</th>
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    <a class="btn btn-xs bg-yellow" type="button"
                                                        href="<?= base_url('admin/transaksi/tambah/' . $x['id_mobil']); ?>"><span
                                                            class="fa fa-car"></span> Sewa</a>
                                                    <a class="btn btn-xs bg-yellow" type="button"
                                                        href="<?= base_url('admin/transaksi/tambah/' . $x['id_mobil']); ?>"><span
                                                            class="fa fa-car"></span> Book</a>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
                                        </tbody>
