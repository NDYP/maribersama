            ...
            <form action="" method="POST">
                <div class="box box-default">
                    <div class="box-header with-border">
                        <a type="button" href="<?= base_url('admin/transaksi/katalog') ?>"
                            ...
                            <div class="col-md-6">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input value="<?= set_value('tanggal_pinjam'); ?>" type="text"
                                            class="form-control" id="datepicker" name="tanggal_pinjam">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input value="<?= set_value('tanggal_kembali'); ?>" type="text"
                                            class="form-control" id="datepicker1" name="tanggal_kembali">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>DP</label>
                                        <input value="<?= set_value('dp'); ?>" type="text" class="form-control"
                                            name="dp">
                                    </div>
                                </div>
                            </div>
