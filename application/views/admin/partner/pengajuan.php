                                            ...
                                            <tbody>
                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>
                                                        <?php if ($x['foto']) : ?>
                                                        <a
                                                            href="<?= base_url('admin/partner/downloadfoto/' . $x['id_pengguna']); ?>">
                                                        ...
                                                        <img class="img center-block img-responsive img-thumnail"
                                                            style="width: 5cm;"
                                                            src="<?= base_url('assets/foto/pengguna/profil.png'); ?>"
                                                            alt="">
                                                        <?php endif; ?>
                                                    </td>
                                                    <td> <a
                                                            href="<?= base_url('admin/partner/downloadktp/' . $x['id_pengguna']); ?>"><?= $x['nik'] ?></a>
                                                    </td>
