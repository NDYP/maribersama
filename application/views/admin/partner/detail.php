        ...
        <section class="content">
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    <a href="<?= base_url('admin/partner/index') ?>" class="btn btn-xs bg-blue"><span
                            ...
                            <table id="" class="table table-striped dataTable" role="grid"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th>Tanggal Lahir</th>
                                        <th> : </th>
                                        <td><?= $partner['tempat_lahir'];
                                            echo ', ' ?><?= date('d-m-Y', strtotime($partner['tanggal_lahir'])); ?>
                                        </td>
                                        <td></td>
                                        <th>No.hp/WA</th>
                                        <th> : </th>
