                    ...
                    <div class="tab-content">
                        <div class="active tab-pane" id="activity">
                            <div class="box-header with-border">
                                <a type="button" href="<?= base_url('admin/partner/index') ?>"
                                    class="btn bg-green btn-xs"><span class="fa fa-arrow-left"></span> Kembali</a>
                            </div>
                            <div class="box-body">
                                <form class="form-horizontal" action="<?= base_url('admin/partner/ubah') ?>"
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td>
                                                <a class="btn btn-xs bg-yellow" type="button"
                                                    href="<?= base_url('admin/partner/hapusberkas/' . $x['id_berkas']); ?>"><span
