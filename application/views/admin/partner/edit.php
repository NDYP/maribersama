        ...
        <section class="content">
            <div class="box box-default">
                <div class="box-header with-border">
                    <a class="btn btn-xs bg-blue" href="<?= base_url('admin/partner/index') ?>"><span
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control" placeholder="id_pengguna"
                                        name="id_pengguna" value="<?= $partner['id_pengguna']; ?>">
                                    <input type="text" class="form-control" value="<?= $partner['nik']; ?>" name="nik">
                                    ...
                                    <div class="">
                                        <label>
                                            <input type="radio" name="jenis_kelamin" value="Laki-laki"
                                                class="minimal-red"
                                                <?php if ($partner['jenis_kelamin'] === 'Laki-laki') echo 'checked'; ?>>
                                            Laki-laki
                                        </label>
                                        <label></label>
                                        <label>
                                            <input type="radio" name="jenis_kelamin" value="Perempuan"
                                                class="minimal-red"
                                                <?php if ($partner['jenis_kelamin'] === 'Perempuan') echo 'checked'; ?>>
                                            Perempuan
                                        </label>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="nama_lengkap"
                                        name="nama_lengkap" value="<?= $partner['nama_lengkap']; ?>">
                                    ...
                                    <div class="row">
                                        <div class="col-md-7">
                                            <input type="text" class="form-control" placeholder="Sewa/Bulan Ke Pemilik"
                                                name="tempat_lahir" value="<?= $partner['tempat_lahir']; ?>">
                                        ...
                                        <div class="col-md-5">
                                            <input type="text" class="form-control" id="datepicker" name="tanggal_lahir"
                                                value="<?= date('d-m-Y', strtotime($partner['tanggal_lahir'])); ?>">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Taris Sewa/hari"
                                        name="username" value="<?= $partner['username']; ?>">
