            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <a class="btn btn-sm bg-green" type="button" href="<?= base_url('admin/karyawan/tambah'); ?>"><span class="fa fa-plus"></span> Tambah</a>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($index as $x) : ?>
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>
                                                        <img class="img center-block img-responsive img-thumnail" style="width: 30%;" src="<?= base_url('assets/foto/pengguna/' . $x['foto']); ?>" alt="">
                                                    </td>
                                                    <td><?= $x['nik'] ?></td>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-xs bg-yellow" type="button" href="<?= base_url('admin/karyawan/edit/' . $x['id_pengguna']); ?>"><span class="fa fa-edit"></span> Edit</a>
                                                        <a class="btn btn-xs bg-yellow" type="button" href="<?= base_url('admin/karyawan/hapus/' . $x['id_pengguna']); ?>"><span class="fa fa-trash"></span> Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
