                ...
                <div class="box">
                    <div class="box-header">
                        <a class="btn btn-xs bg-green" type="button"
                            href="<?= base_url('admin/karyawan/tambah'); ?>"><span class="fa fa-plus"></span> Tambah</a>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    <a class="btn btn-xs bg-blue" type="button"
                                                        href="<?= base_url('admin/karyawan/edit/' . $x['id_pengguna']); ?>"><span
                                                            class="fa fa-eye"></span> Lihat</a>
                                                    <a class="btn btn-xs bg-yellow" type="button"
                                                        href="<?= base_url('admin/karyawan/hapus/' . $x['id_pengguna']); ?>"><span
