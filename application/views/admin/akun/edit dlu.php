            ...
            <div class="col-md-4">
                ...
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        <img class="img center-block img-responsive img-rounded" src="<?= base_url('assets/foto/pengguna/' . $akun['foto']); ?>" alt="User profile picture">
                    </div>
                    <!-- /.box-body -->
                </div>
                <!-- /.box -->
                ...
                <div class="nav-tabs-custom">
                    ...
                    <div class="tab-content">
                        <div class="active tab-pane" id="activity">
                            <div class="box-body">
                                <form class="form-horizontal" action="<?= base_url('admin/akun/ubah'); ?>" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label for="inputEmail" class="col-sm-2 control-label">Username</label>
                                        <div class="col-sm-3">
                                            <?php if ($this->session->userdata('username_admin')) : ?>
                                                <input type="text" class="form-control" id="inputEmail" placeholder="Nama Lengkap" name="username" value="<?= $this->session->userdata('username_admin'); ?>">
                                            <?php else : ?>
                                                <input type="text" class="form-control" id="inputEmail" placeholder="Nama Lengkap" name="username" value="<?= $akun['username']; ?>">
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <?php if ($this->session->userdata('password_admin')) : ?>
                                                <input type="password" class="form-control" id="inputEmail" placeholder="Nama Lengkap" name="password" value="<?= $this->session->userdata('password_admin'); ?>">
                                            <?php else : ?>
                                                <input type="password" class="form-control" id="inputEmail" placeholder="Nama Lengkap" name="password" value="<?= $akun['password']; ?>">
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control" id="inputName" placeholder="NIK" name="nik" value="<?= $akun['nik']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputEmail" class="col-sm-2 control-label">Nama Lengkap</label>
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control" id="inputEmail" placeholder="Nama Lengkap" name="nama_lengkap" value="<?= $akun['nama_lengkap']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputEmail" class="col-sm-2 control-label">Tempat, tanggal
                                            lahir</label>
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control" id="inputEmail" placeholder="Nama Lengkap" name="tempat_lahir" value="<?= $akun['tempat_lahir']; ?>">
                                        </div>
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control" id="datepicker" name="tanggal_lahir" value="<?= $akun['tanggal_lahir']; ?>">
                                        </div>
                                    </div>
                                    <div class=" form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <label>
                                                <input type="radio" name="jenis_kelamin" value="Laki-laki" class="minimal-red" <?php if ($akun['jenis_kelamin'] == 'Laki-laki') echo 'checked'; ?>>
                                                Laki-laki
                                            </label>
                                            <label></label>
                                            <label>
                                                <input type="radio" name="jenis_kelamin" value="Perempuan" class="minimal-red" <?php if ($akun['jenis_kelamin'] == 'Perempuan') echo 'checked'; ?>>
                                                Perempuan
                                            </label>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control" id="inputEmail" placeholder="Nama Lengkap" name="alamat" value="<?= $akun['alamat']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputEmail" class="col-sm-2 control-label">Telepon/No.Hp/WA</label>
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control" id="inputEmail" placeholder="Nama Lengkap" name="no_hp" value="<?= $akun['no_hp']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputEmail" class="col-sm-2 control-label">Email</label>
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control" id="inputEmail" placeholder="Nama Lengkap" name="email" value="<?= $akun['email']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input accept=".jpg, .jpeg, .png" title="Hanya tipe Foto " type="file" name="foto"></input>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <button type="submit" class="btn bg-green btn-xs" title="simpan"><span class="fa fa-save"></span> Upload</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($berkas as $x) : ?>
                                            <tr role="row" class="odd">
                                                ...
                                                <td><?= $x['daftar'] ?></td>
                                                <td>
                                                    <a class="btn btn-xs bg-yellow" type="button" href="<?= base_url('admin/akun/hapusberkas/' . $x['id_berkas']); ?>"><span class="fa fa-trash"></span> Hapus</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <button type="submit" class="btn bg-green btn-xs" title="simpan"><span class="fa fa-save"></span> Ajukan</button>
                                                </div>
                                            </div>
                                            <!-- /.form-group -->
                                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($mobil as $x) : ?>
                                            <tr role="row" class="odd">
                                                <td class="sorting_1"><?= $no++; ?></td>
                                                <td>
                                                    <img class="img center-block img-responsive img-thumnail" style="width: 3cm; height:4cm;" src="<?= base_url('assets/foto/mobil/' . $x['thumbnail']); ?>" alt="">
                                                </td>
                                                <td><?= $x['tipe'] ?> <br>
                                                    <?= $x['jenis'] ?>
                                                </td>
                                                ...
                                                <td>
                                                    <a class="btn btn-xs bg-yellow" type="button" href="<?= base_url('admin/akun/editmobil/' . $x['id_mobil']); ?>"><span class="fa fa-edit"></span> Lihat</a>
                                                    <a class="btn btn-xs bg-yellow" type="button" href="<?= base_url('admin/akun/hapusmobil/' . $x['id_mobil']); ?>"><span class="fa fa-trash"></span> Hapus</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
