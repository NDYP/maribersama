    ...
    <div class="container">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?= base_url('admin/customer/index'); ?>"> <?= $title; ?></a></li>
        ...
        <section class="content">
            <div class="box box-default">
                <div class="box-header with-border">
                    <a href="<?= base_url('admin/akun/profil') ?>" class="btn btn-xs bg-blue"><span
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="id_pemilik" value="<?= $akun['id_pengguna']; ?>" type="hidden"
                                        class="form-control" id="exampleInputEmail1" placeholder="isi ...">
