            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <a class="btn btn-sm bg-green" type="button" href="<?= base_url('admin/partner/tambah'); ?>"><span class="fa fa-plus"></span> Tambah</a>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($index as $x) : ?>
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>
                                                        <a class="btn btn-xs bg-yellow" type="button" href="<?= base_url('admin/partner/edit/' . $x['id_pengguna']); ?>"><span class="fa fa-edit"></span> Edit</a>
                                                        <a class="btn btn-xs bg-yellow" type="button" href="<?= base_url('admin/partner/hapus/' . $x['id_pengguna']); ?>"><span class="fa fa-trash"></span> Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
