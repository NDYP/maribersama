        ...
        <section class="content">
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    <a href="<?= base_url('admin/customer/index') ?>" class="btn btn-xs bg-blue"><span
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <center>
                                ...
                                <a href="<?= base_url('admin/customer/download/' . $customer['id_pengguna']); ?>">
                                    <img class="img center-block img-responsive profile-user-img"
                                        src="<?= base_url('assets/foto/pengguna/' . $customer['foto']); ?>" alt=""
                            ...
                            <table id="" class="table table-striped dataTable" role="grid"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th>Tanggal Lahir</th>
                                        <th> : </th>
                                        <td><?= $customer['tempat_lahir'];
                                            echo ', ' ?><?= date('d-m-Y', strtotime($customer['tanggal_lahir'])); ?>
                                        </td>
                                        <td></td>
                                        <th>No.hp/WA</th>
                                        <th> : </th>
