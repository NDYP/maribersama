                                        ...
                                        <tbody>
                                            ...
                                            foreach ($index as $x) : ?>
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td><?= $x['daftar'] ?></td>
                                                    <td>
                                                        <a class="btn btn-xs bg-yellow" type="button" href="<?= base_url('admin/customer/edit/' . $x['id_pengguna']); ?>"><span class="fa fa-edit"></span> Edit</a>
                                                        <a class="btn btn-xs bg-yellow" type="button" href="<?= base_url('admin/customer/hapus/' . $x['id_pengguna']); ?>"><span class="fa fa-trash"></span> Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
