...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="row">
            <form enctype="multipart/form-data" role="form" action="<?= base_url('admin/berita/tambah'); ?>" method="post" class="form-horizontal">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box">
                        <div class="box-header with-border">
                            <a href="<?= base_url('admin/berita/index'); ?>" class="btn bg-green btn-social btn-flat btn-sm visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block" title="Kembali"><i class="fa fa-arrow-left"></i> Kembali</a>
                        </div>
                        <div class="box-body">
                            <div class="row">
                                <div class="col-xs-8">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <button style="background-color:orange;" type="button" class="btn btn-block btn-md"><strong>ISI ARTIKEL</strong></button>
                                </div>
                            </div>
                            <br>
                            <div class="row">
