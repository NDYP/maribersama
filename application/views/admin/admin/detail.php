                    ...
                    <div class="tab-content">
                        <div class="active tab-pane" id="activity">
                            <div class="box-header with-border">
                                <a type="button" href="<?= base_url('admin/admin/index') ?>"
                            ...
                            <div class="box-body">
                                <form class="form-horizontal" action="<?= base_url('admin/admin/ubah') ?>" method="post"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control" id="inputEmail"
                                                placeholder="Nama Lengkap" name="tanggal_lahir"
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td>
                                                <a class="btn bg-yellow-gradient btn-social btn-flat btn-xs visible-xs-block visible-sm-inline-block visible-md-inline-block visible-lg-inline-block"
                                                    type="button"
                                                    href="<?= base_url('admin/admin/hapusberkas/' . $x['id_berkas']); ?>"><span
