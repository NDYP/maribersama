            ...
            <div class="box box-default">
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-12">
                            <center>
                                <a href="<?= base_url('admin/mobil/download/' . $index2['id_mobil']); ?>">
                                    <?php if ($index2['thumbnail']) : ?>
                                    <img class="img center-block img-responsive profile-user-img"
                                        src="<?= base_url('assets/foto/mobil/' . $index2['thumbnail']); ?>" alt=""
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    ...
                                                    <li>
                                                        <a href="<?= base_url('admin/pengajuan/hapusberkas/' . $x['id_berkas']); ?>"
